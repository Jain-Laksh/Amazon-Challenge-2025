...
# --- Configuration ---
INPUT_CSV = "test.csv"
OUTPUT_CSV = "siglip_embeddings_test.csv"
MODEL_NAME = "google/siglip-large-patch16-384"
BATCH_SIZE = 256  # Adjust based on A100 VRAM (e.g., 256, 512)
NUM_WORKERS = 8   # Adjust based on CPU cores

# --- Dataset Definition ---
class ImageURLDataset(Dataset):
    def __init__(self, urls, processor):
        self.urls = urls
...
if __name__ == '__main__':
    ...
    dataset = ImageURLDataset(image_links, processor)
    ...
    for image_batch, url_batch in tqdm(dataloader):
        ...
        # Use pooler_output for SigLIP vision embeddings
